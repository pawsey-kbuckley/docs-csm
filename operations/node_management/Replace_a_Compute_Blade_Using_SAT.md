...
1. Shut down the nodes on the target blade.
   ...
   Use the `sat bootsys` command to shut down the nodes on the target blade. Specify the appropriate component name (xname), and BOS templates determined in the prvious step in a comma-separated list.
